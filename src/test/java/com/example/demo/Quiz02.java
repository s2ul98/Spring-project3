...
public class Quiz02 {
	...
	@Test
	public void 오만원이상검색() {
		List<Gift> list = giftRepository.findByPrice(50000);
	...
	@Test
	public void 세트검색() {
		List<Gift> list = giftRepository.findByName("%세트");
	...
	@Test
	public void 생활용품_가격검색() {
		List<Gift> list = giftRepository.getByPriceAndType(40000,"생활용품");
